...
var workoutDistanceUnits = []DistanceUnitSyntax{
	...
	{Key: "distance_yd", Canonical: "yrd", Aliases: []string{"yrd", "yd", "yard", "yards"}, Description: "Yards serialize with the canonical `yrd` suffix for pool-swim distances."},
}
	...
	return SyntaxSpec{
		...
		Features: []SyntaxFeature{
			...
			},
			{
				...
				Description: "Distance steps serialize with canonical mtr, km, mi, or yrd suffixes.",
				Examples: []SyntaxExample{
